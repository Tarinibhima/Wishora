...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    loadWishlists().catch(() => navigate("/", { replace: true }));
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                onClick={async () =>
                  navigator.clipboard.writeText(`${origin}/wishlist/${selectedWishlist.id}`)
                }
              >
                Copy
              </button>
            ...
            {selectedWishlist.items.map((entry) => (
              ...
              >
                ...
                <p className="mt-3 text-sm">
                  Status:{" "}
                  <span className={entry.status === "Taken" ? "text-red-300" : "text-green-300"}>
                    {entry.status}
                  </span>
                </p>
              </motion.article>
