  ...
  const handleAuth = async (event) => {
    ...
    try {
      ...
      if (message) {
        ...
        setError("Network/API error. Check that the backend is running and CORS allows this origin.");
      }
    } finally {
      setLoading(false);
    }
    ...
    <>
      ...
      <main className="relative min-h-screen overflow-x-hidden">
        ...
        <section className="relative z-10 min-h-screen px-6 py-20 sm:px-10">
          ...
          >
            <h3 className="cinematic-title mb-10 text-center text-4xl text-[#e3edf8] sm:text-6xl">
              How to use
            </h3>
